...
from auto_ovpn import parse_options_from_yaml, write_complete_config, get_all_clients_by_keyfiles
...
def main():
    ...
    print(
        "This is {} version {} ({})\n".format(
            auto_ovpn.name, auto_ovpn.__version__, auto_ovpn.__full_revisionid__
        )
    )
